package datastructureandalgoritham;

import java.util.ArrayList;
import java.util.Scanner;

/**
 * 1. array of numbers of given range
 * 2.takes range from user
 * 3. calculates maximum count of questions
 * 4. asks user if the number is in given range and reduces the range 
 * 5.replaces all the integer in the array to -1 as the number is not in this range
 * 6.Creating and object
 * 7.calling start method in object
 */
...
public class FindYourNumber {
	...
	/*
	 * 5.replaces all the integer in the array to -1 as the number is not in this
	 * range
	 */
